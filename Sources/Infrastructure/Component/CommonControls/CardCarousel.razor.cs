...
using Component.ProductControls;
using Microsoft.AspNetCore.Components;

namespace Component.CommonControls
{
    public partial class CardCarousel : ComponentBase
    {
        ...
        public CardCarousel()
        {
            ...
            Carousel.Add(new CardCarouselItem("assets/IMG_1892.jpg", "plein de blde  blab laabla;"));
            ...
            Carousel.Add(new CardCarouselItem("assets/IMG_1892.jpg", "plein de blabla;"));
